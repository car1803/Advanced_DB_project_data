...
def main():
    ...
    execute_command("mongos", 'db = connect("localhost/egresados"); db.hregistrotrabajo.createIndex({"cargo": "text", "destudiante.nombre": "text", "dempresa.descripcion":"text", "dempresa.nombre":"text", "dtrabajoestudiantecarrera.nombrefacultad":"text"},{ default_language: "spanish" })', 27017)
    execute_command("mongos", 'db = connect("localhost/egresados"); db.hregistroestudioidioma.createIndex({"destudiante.nombre" : "text", "destudianteidioma.nombrefacultad":"text", "destudianteidioma.nombresede":"text", "destudiante.documento":"text"}, { default_language: "english" })', 27017)
